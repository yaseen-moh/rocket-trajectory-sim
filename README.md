...
**[Try the live demo →](./demo/index.html)** (drag sliders for dry mass, body diameter, fin root chord/span/count, motor selection, parachute toggle, launch angle, and wind — the trajectory and a rough stability check redraw live in the browser, no install needed.)
